...
//        System.out.println(parser.getInteger("option"));
    ...
    //Keeping getInteger and switching to different parsers
    @Test
...
//        System.out.println(parser.getInteger("option"));
    ...
    @Test
    public void test_getInteger_BigInt() {//TODO come back to. This test doesn't really make sense.
        parser.add("option","o", Parser.INTEGER);
...
//        System.out.println(parser.getInteger("option"));
    ...
    @Test
    public void test_getInteger_BiggerInt() {//TODO come back to. This test doesn't really make sense.
        parser.add("option","o", Parser.INTEGER);
...
//        System.out.println(parser.getInteger("option"));
    ...
    public void OptionMapTest_1() { //Makes sure runtime exception is thrown
        parser.add(null, Parser.STRING);
    }
    @Test(expected = RuntimeException.class)
    public void OptionMapTest_2() { //Makes sure runtime exception is thrown
        parser.add(null,null, Parser.STRING);
    }
    @Test(expected = RuntimeException.class)
    public void OptionMapTest_3() { //Makes sure runtime exception is thrown
        parser.add("option",null, Parser.STRING);
    }
    @Test(expected = RuntimeException.class)
    public void OptionMapTest_4() { //Makes sure runtime exception is thrown
        parser.add(null,"option", Parser.STRING);
    }
    @Test(expected = RuntimeException.class)
    public void OptionMapTest_5() { //Makes sure runtime exception is thrown
        parser.add("option","o",-8);
    }
    @Test(expected = RuntimeException.class)
    public void OptionMapTest_6() { //Makes sure runtime exception is thrown
        parser.add("option","o",10);
    }
    @Test(expected = RuntimeException.class)
    public void OptionMapTest_7() { //Makes sure runtime exception is thrown
        parser.add("","o",1);
    }
    @Test(expected = RuntimeException.class)
    public void OptionMapTest_8() { //Makes sure runtime exception is thrown
        parser.add("","",1);
    }


    // Task 1 tests pasted here
